...
- [pulse-touching test seam は object.\_\_new\_\_ + 手動 \_pulse で実 daemon テスト](feedback_pulse_test_seam_via_object_new.md) — pulsectl event loop race を避けつつ \_module_load_raw 等の薄ラッパー seam を実 Pulse で delegate 検証するパターン
