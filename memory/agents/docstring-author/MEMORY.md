...
- [vrcpilot.speaker.linux per-PID design docstring patterns](project_speaker_linux_per_pid.md) — routing replacement vs addition, LIFO teardown, trailing-`\s` anchor, ExitStack callback-name preservation
