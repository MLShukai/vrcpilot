...
direct-spawns VRChat under [umu-launcher](https://github.com/Open-Wine-Components/umu-launcher),
...
For other distributions or building from source, see the official README:
